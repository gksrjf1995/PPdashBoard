  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        <div className='bg-slate-500 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>수익</p>
              <p className='text-2xl'>$63,44,878</p>
            </div>
          </div>
          <div className='mt-6'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center '>
            <div className='border-r-1 border-color m-4 pr-10 '>
              ...
              <div className='mt-5'>
                ...
                />
                <div className='mt-10'>
                  <Button color={"white"} bgColor={currentColor} text={"다운로드"} borderRadius="10px"/>
                </div>
              </div>
            </div>
