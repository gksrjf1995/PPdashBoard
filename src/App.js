    ...
    <div>
      <BrowserRouter>
        <div className=' flex  relative dark:bg-main-dark-bg '>
          <div className='fixed  right-4 bottom-4 overflow-hidden'  style={{zIndex : '100'}}>
        ...
        {activemenu ? <div className='absolute top-0 w-72  sidebar dark:bg-secondary-dark-bg bg-white'>
          <Sidebar/> 
        </div> : <div className='md:overflow-x-hidden overflow-hidden hidden w-0 dark:bg-secondary-dark-bg '>
          <Sidebar/> 
        </div>  
        }
